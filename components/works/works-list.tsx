...
export const WorksList: FC<WorksListProps> = ({ projects }) => {
  ...
  return (
    <motion.div
      className="w-full flex flex-col gap-25 md:min-h-[calc(100svh-390px)] relative"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    ...
    >
      <div className="w-full site-grid text-list-title italic">
        <div className="col-span-4 md:col-span-10 lg:col-span-9 md:grid md:grid-cols-9 gap-x-20 text-black dark:text-grey">
