...
export const Cursor: FC<CursorProps> = (props) => {
  ...
  return (
    <motion.div
      ref={cursorRef}
      className="fixed top-0 w-40 left-0 z-[5] pointer-events-none cursor-none text-nav grid-contain text-center place-items-center text-white mix-blend-difference"
